...
# ---- Routes (unchanged) ----
# I'll skip the route functions here to save space – they are identical to the previous version.
# The routes are exactly the same as in the last full code I provided.
# I will include them in the final file.
...
# (All admin command functions are identical to the previous version)
